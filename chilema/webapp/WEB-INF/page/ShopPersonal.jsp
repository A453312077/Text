			...
			<ul id="list">
				<c:forEach items="${order.list}" var="Order">
					<ul id="test">
						...
						<c:forEach items="${Order.menuorder}" var="listaksdhjasd">
	      						菜名:${listaksdhjasd.menuName},
	      						价格:${listaksdhjasd.price},
	      						数量:${listaksdhjasd.num}
	      						<br>
	      					</c:forEach>


						<br /> 点击我! 查看配送信息:
						<li id="test">${order.userId}</li>
						<br />
						<div id="lijianzhangSB"></div>
						...
						<span style="color: red"><a style="color: red"
							href="delectUserOrder?orderId=${Order.orderId}">删除接单</a></span>
