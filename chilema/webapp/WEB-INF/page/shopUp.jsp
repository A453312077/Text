...
<html>
	<head>
		...
		<script src="assets/js/uploadMenu.js" type="text/javascript" charset="utf-8"></script>
	...
	<div class="topbar">
		...
		<div id="chengweishagnjia">
			<h3 style="color: deepskyblue; margin: 0px 0px; margin-left: 10px;">上传菜品</h3>
			<hr style=" border: 1px solid deepskyblue;">
			<form id="upload_form" >
				   <div id="">
				   	<div id="">
				   		<img id="preview" style="width: 80px; height: 80px;" alt="菜品图片"/><br />
    					<p id="tijiao">
    					<input type="file" name="files" onchange="imgPreview(this)" />
    					选择图片
    					</p>
    					<input type="text" name="shopName" id="dianming" placeholder="请输入菜品名称" />
    					<input type="number" name="shopPice" id="dianming" placeholder="请输入菜品价格" />
				   	</div>
