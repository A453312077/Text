				...
				<form id="form" class="bs-example bs-example-form" role="form">
					<div class="input-group">
						<span class="input-group-addon">账号</span> <input type="text"
							class="form-control" disabled="disabled" value="${user.phone}"
							id="phone">
					</div>
					<br>
					<div class="input-group">
						<span class="input-group-addon">昵称</span> <input type="text"
							class="form-control" value="${user.nickName}" id="nickName">
					</div>
					<br>
					<div class="input-group">
					...
					<div class="input-group">
						<span class="input-group-addon">邮箱</span> <input type="text"
							class="form-control" value="${user.email}" id="email">
					</div>
					<br>
					<div class="input-group">
						<span class="input-group-addon">地址</span> <input type="text"
							class="form-control" value="${user.roomAddress}" id="roomAddress">
					</div>
					<input type="button" class="btn-success btn-lg" value="保存修改"
						id="subm">
				</form>
